const items = [
  {
    ...
    highlights: [
      'Developed cost attribution calculation for FPD Kafka Usage (CEA data stack)',
      'Enhanced and audited kaas Inventory and Usage pipelines',
      'Built end-to-end workflow for kaas ownership computation',
      'Gained hands-on experience with Netflix Data Engineering tools and datasets',
    ],
    description: [
      'Enhanced kaas Inventory and Usage pipelines by adding audit capabilities, improving data quality and traceability.',
      'Developed and deployed an end-to-end workflow to compute kaas ownership and write results to the common entity ownership table.',
      'Designed and implemented cost attribution calculation for FPD Kafka Usage as the first step of the CEA data stack, delivering production-ready code and documentation.',
    ],
  },
  {
